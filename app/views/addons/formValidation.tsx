        ...
        <Row>
          ...
          <article>
            ...
            <ul>
              ...
              <li>Form elements e.g. <code>{`<TextInput />`}</code> or <code>{`<DatePickerInput />`}</code></li>
            </ul>
            ...
            <Grid className="form-grid">
              ...
              <Row>
                <Col className="invalid">
                  ...
                  <TextInput defaultValue="john@com" rightIcon={TextInput.Icomoon.warning2} placeholder="e.g. yourname@example.com" />
